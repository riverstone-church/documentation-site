...
<div class="max-w-xl mx-auto text-center print:mt-10 print:mb-5 print:text-left">
    @if($page->image)
    ...
    <a class="hidden print:inline-block underline" href="{{ $page->getUrl() }}">{{ $page->getUrl() }}</a>
</div>
@endsection
@section('after')
