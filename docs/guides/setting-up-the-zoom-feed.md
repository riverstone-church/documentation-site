# Setting Up the Zoom Feed

## Turn the Streaming Equipment On

See [Turning the Media Equipment On](turning-the-media-equipment-on.md).

## Start the Zoom Meeting

1. Open up Zoom and start the meeting.

![](../assets/setting-up-the-zoom-feed/select-zoom-meeting.jpeg)
![](../assets/setting-up-the-zoom-feed/start-zoom-meeting.jpeg)

2. Verify the correct audio source is selected and the microphone icon is unmuted.

![](../assets/setting-up-the-zoom-feed/select-audio-source.jpeg)
...
![](../assets/setting-up-the-zoom-feed/verify-obs-settings.jpeg)
...
![](../assets/setting-up-the-zoom-feed/start-virtual-camera.jpeg)

2. In Zoom, select “OBS Virtual Camera” as the video source.

![](../assets/setting-up-the-zoom-feed/select-video-source.jpeg)

3. Enable video

![](../assets/setting-up-the-zoom-feed/enable-video.jpeg)
...
![](../assets/setting-up-the-zoom-feed/start-recording.jpeg)
