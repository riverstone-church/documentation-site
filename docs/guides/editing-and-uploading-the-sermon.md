# Editing and Uploading the Sermon
...
![](../assets/editing-and-uploading-the-sermon/folder-structure.png)
...
-   Add the intro video; overlapping the audio to make a smooth transition to the sermon.
    ![](../assets/editing-and-uploading-the-sermon/final-cut-pro-timeline-intro.png)
...
-   Add the outro; overlapping the audio and having it fade out.
    ![](../assets/editing-and-uploading-the-sermon/final-cut-pro-timeline-outro.png)

## Export

Export both a video and audio only version of the final edit. Refer to _Naming and Organization Conventions_ for the naming convention.
...
After exporting the video, the next step is to upload it to Vimeo under the `Sermons` folder. Refer to _Naming and Organization Conventions_ for what to title the video.
...
-   Set the video language to `English (United States)`
    ![](../assets/editing-and-uploading-the-sermon/vimeo-setting-language.gif)
...
-   Add a Squarespace audio block and upload the audio only version you exported earlier.
    ![](../assets/editing-and-uploading-the-sermon/squarespace-audio-block.png)
    ![](../assets/editing-and-uploading-the-sermon/squarespace-uploading-audio-file.png)

-   Set the `Title` to the title and the `Author/Artist` to the preacher’s name
    ![](../assets/editing-and-uploading-the-sermon/squarespace-audio-file-uploaded.png)
